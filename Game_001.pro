...
unrealRootPath=/home/aswiatkowska/Bin/UnrealEngine-4.25
Game_001RootPath=/home/aswiatkowska/Desktop/BasicGame

gameProjectFile=/home/aswiatkowska/Desktop/BasicGame/Game_001.uproject
...
include(Game_001Source.pri)
include(Game_001Header.pri)
include(Game_001Config.pri)
include(Game_001Includes.pri)
include(Game_001Defines.pri)
...
Game_001-Linux-Debug.commands = $$build Game_001 Linux Debug  -project="\"$$gameProjectFile\"" $$args
Game_001-Linux-DebugGame.commands = $$build Game_001 Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Game_001-Linux-Shipping.commands = $$build Game_001 Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Game_001-Linux-Test.commands = $$build Game_001 Linux Test  -project="\"$$gameProjectFile\"" $$args
Game_001.commands = $$build Game_001 Linux Development  -project="\"$$gameProjectFile\"" $$args

Game_001Editor-Linux-Debug.commands = $$build Game_001Editor Linux Debug  -project="\"$$gameProjectFile\"" $$args
Game_001Editor-Linux-DebugGame.commands = $$build Game_001Editor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Game_001Editor-Linux-Shipping.commands = $$build Game_001Editor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Game_001Editor-Linux-Test.commands = $$build Game_001Editor Linux Test  -project="\"$$gameProjectFile\"" $$args
Game_001Editor.commands = $$build Game_001Editor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	UE4Server \
	Game_001-Linux-Debug \
	Game_001-Linux-DebugGame \
	Game_001-Linux-Shipping \
	Game_001-Linux-Test \
	Game_001 \
	Game_001Editor-Linux-Debug \
	Game_001Editor-Linux-DebugGame \
	Game_001Editor-Linux-Shipping \
	Game_001Editor-Linux-Test \
	Game_001Editor \
