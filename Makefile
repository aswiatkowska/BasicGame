...
UNREALROOTPATH = /home/aswiatkowska/Bin/UnrealEngine-release(1)/UnrealEngine-release
GAMEPROJECTFILE =/home/aswiatkowska/Desktop/BasicGame 4.26/Game_001.uproject
...
Game_001-Linux-Debug:
	 $(PROJECTBUILD) Game_001 Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Game_001-Linux-DebugGame:
	 $(PROJECTBUILD) Game_001 Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Game_001-Linux-Shipping:
	 $(PROJECTBUILD) Game_001 Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Game_001-Linux-Test:
	 $(PROJECTBUILD) Game_001 Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Game_001:
	 $(PROJECTBUILD) Game_001 Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

Game_001Editor-Linux-Debug:
	 $(PROJECTBUILD) Game_001Editor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Game_001Editor-Linux-DebugGame:
	 $(PROJECTBUILD) Game_001Editor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Game_001Editor-Linux-Shipping:
	 $(PROJECTBUILD) Game_001Editor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Game_001Editor-Linux-Test:
	 $(PROJECTBUILD) Game_001Editor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Game_001Editor:
	 $(PROJECTBUILD) Game_001Editor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
